...
public class DidaTradeMainServiceImpl
    extends DidaTradeMainServiceGrpc.DidaTradeMainServiceImplBase {
  ...
  public void populate(
      DidaTradeMain.PopulateRequest request,
    ...
    DidaTradeMain.PopulateReply response =
        DidaTradeMain.PopulateReply.newBuilder().setReqid(reqid).setResult(result).build();
  ...
  @Override
  public void adduser(
      DidaTradeMain.AddUserRequest request,
    ...
    DidaTradeMain.AddUserReply response =
        DidaTradeMain.AddUserReply.newBuilder().setReqid(reqid).setResult(result).build();
  ...
  public void buy(
      DidaTradeMain.BuyRequest request, StreamObserver<DidaTradeMain.BuyReply> responseObserver) {
    // for debug purposes
    ...
    DidaTradeMain.BuyReply response =
        DidaTradeMain.BuyReply.newBuilder().setReqid(reqid).setResult(result).build();
  ...
  @Override
  public void sell(
      DidaTradeMain.SellRequest request, StreamObserver<DidaTradeMain.SellReply> responseObserver) {
    // for debug purposes
    ...
    DidaTradeMain.SellReply response =
        DidaTradeMain.SellReply.newBuilder().setReqid(reqid).setResult(result).build();
  ...
  @Override
  public void balance(
      DidaTradeMain.BalanceRequest request,
    ...
    DidaTradeMain.BalanceReply response =
        DidaTradeMain.BalanceReply.newBuilder()
            .setReqid(reqid)
            .setResult(result)
            .setBalance(balance)
            .build();
  ...
  @Override
  public void dump(
      DidaTradeMain.DumpRequest request, StreamObserver<DidaTradeMain.DumpReply> responseObserver) {
    // for debug purposes
    ...
    DidaTradeMain.DumpReply response =
        DidaTradeMain.DumpReply.newBuilder().setReqid(reqid).setResult(result).build();
